...
const HeroSection = ({openSignIn, openSignUp}) => {
  return (
    <div className='landing-page-content relative'>
        <div className='absolute inset-0 bg-gradient-to-b from-purple-50 to-indigo-50 opacity-80 z-0 pointer-events-none'></div>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 '>
            <div className='pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28'>
                <div className='text-center'>
                    <h1 className='text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text:4xl'>
                        ...
                        <span className='block text-purple-500'>CloudeShare</span>
                    </h1>
                    <p className='mt-3 max-w-20 mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl'>
            ...
            <div className='relatave'>
                <div className='aspect-w-16 rounded-lg shadow-lg overflow-hidden'>
                    <img src={dashboard_image} alt="cloudshare dashboard" className='w-full h-full object-cover'/>
                </div>
